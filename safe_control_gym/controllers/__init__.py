...
register(id="gp_mpc_hexa_bigdrone",
         entry_point="safe_control_gym.controllers.mpc.gp_mpc_hexa_bigdrone:GPMPC",
         config_entry_point="safe_control_gym.controllers.mpc:gp_mpc_bigdrone.yaml")
